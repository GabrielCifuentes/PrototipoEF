...
public class daoProductos {
    ...
    private static final String SQL_SELECT = "SELECT prod_codigo, prod_nombre, lin_codigo, prodestatus,tbl_productos.marcodigo, tbl_lineas.lincodigo,tbl_marcas.marnombre, tbl_lineas.linnombre FROM tbl_productos INNER JOIN tbl_marcas  ON tbl_productos.marcodigo = tbl_marcas.marcodigo INNER JOIN tbl_lineas  ON tbl_productos.lincodigo = tbl_lineas.lincodigo;";
